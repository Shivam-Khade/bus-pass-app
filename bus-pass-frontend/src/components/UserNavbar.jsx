  ...
  return (
    <>
              ...
              <Box visibleFrom="md">
                <Menu shadow="xl" width={240} position="bottom-end" withArrow>
                  <Menu.Target>
                    ...
                    >
                      <Avatar size="sm" radius="xl" color="violet" variant="filled">
                        {user?.name?.charAt(0)}
                      </Avatar>
                      <div>
          ...
          >
            <Stack mt="md">
              <div style={{
                ...
                <Group gap="sm">
                  <Avatar size="lg" radius="xl" color="violet" variant="filled">
                    {user?.name?.charAt(0)}
                  </Avatar>
                  <div>
      ...
      <Modal
        ...
        withCloseButton={false} // Cleaner look, click outside or x
